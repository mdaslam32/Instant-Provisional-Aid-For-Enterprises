    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
		           ...
		           <li class="menu-active"><a href="adminlog.php">Admin Login</a></li>
...
$result=mysqli_query($link,"select * from admin where uname='$username' and psw='$password'") or die("failed to query database".mysqli_error($link));
