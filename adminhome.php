...
<body id="back">
    ...
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
       ...
       <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li  class="menu-active"><a href="adminhome.php">JobSeekers Info</a></li>
          <li><a href="viewu.php">Enterprises Info</a></li>
   ...
   <table style="width:100%;"> 
        ...
        <thead>
            <tr>
                <th style="width:10%;"><h4>Id</h4></th>
				<th style="width:10%;"><h4>Name</h4></th>
                <th style="width:10%;"><h4>Age</h4></th>
				<th style="width:10%;"><h4>Gender</h4></th>
					<th style="width:10%;"><h4>Marital Status</h4></th>
				<th style="width:10%;"><h4>Aadhaar Number</h4></th>
				<th style="width:10%;"><h4>Address</h4></th>
			
				<th style="width:10%;"><h4>Location</h4></th>
	...
	$conn = mysqli_connect("localhost","root","","intern1") or die("failed to connect database");	
		...
		$qry1=mysqli_query($conn,"select * from student");
		while($row1=mysqli_fetch_array($qry1)){
		?>
        <tr>
			    <td><div align="center"><?php echo $row1['sid'];?></div></td>
		   ...
		   <td><div align="center"><?php echo $row1['sname'];?></div></td>
			  <td><div align="center"><?php echo $row1['age'];?></div></td>
			    <td><div align="center"><?php echo $row1['gender'];?></div></td>
				  <td><div align="center"><?php echo $row1['m_status'];?></div></td>
			   <td><div align="center"><?php echo $row1['adnum'];?></div></td>
			   		   <td><div align="center"><?php echo $row1['address'];?></div></td>
					     <td><div align="center"><?php echo $row1['location'];?></div></td>
