...
<body>
    ...
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Enterprise Login</a></h1>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li  class="menu-active"><a href="#about">Enterprise Login</a></li>
          <li><a href="studentlogin.php">Jobseekers Login</a></li>
        </ul>
      </nav>
    </div>
        ...
        <form action="#" method="POST">
			<br>
            <label for="user"> Enterprise Username </label>
            <input type="text" id="user" placeholder="Enter Username" name="user" autocomplete="off" >
			<br><br>
            <label for="pass"> Enterprise Password </label>
...
if(isset($_POST['submit']))
{
 ...
 $username= $_POST['user'];
 $password= $_POST['pass']; $link=mysqli_connect("localhost","root","","intern1") or die($link); 


$result=mysqli_query($link,"select * from employee where eid='$username' and pass='$password'") or die("failed to query database".mysqli_error($link));
