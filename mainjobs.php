      ...
      <div id="logo" class="pull-left">
       ...
       <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="mainjobs.php">View Jobs</a></li>
...
<table width="97%" align="center">
	...
	<tr>
		...
		$qry=mysqli_query($conn,"select * from job");
		$i=1;
			   ...
			   <td><div align="center"><?php echo $row['too'];?></div></td>
						    <td><div align="center"><?php echo $row['salary'];?></div></td>
													    <td><div align="center"><?php echo $row['address'];?></div></td>
														 <td><div align="center"><a href="apply.php?id=<?php echo $row['id'];?>">Apply</a></div></td>
